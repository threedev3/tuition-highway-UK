...
const SubjectDetailComp = ({ subject, handleNavClick }) => {
            ...
            {Object.keys(subject.content || {}).map((curriculum, index) => (
              <motion.button
                ...
                className={`sm:px-6 px-4 rounded-full sm:text-base text-xs sm:w-auto w-full sm:py-1.5 py-1 transition-all duration-300 whitespace-nowrap ${
                  curriculum === "gcse" ? "uppercase" : "capitalize"
                } ${
        ...
        <div className="max-w-[1400px] mx-auto ">
          <div className="max-w-full ">
            {outcomes.map((item, index) => (
              <div
                className="lg:flex lg:flex-row lg:justify-between lg:items-center lg:gap-4 flex flex-col gap-6"
                key={index}
              >
