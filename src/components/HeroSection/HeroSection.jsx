              ...
              {currentHeading === 0 ? (
                ...
                <div className="flex flex-col sm:gap-6 gap-4" key="heading2">
                  <motion.h2
                    ...
                    className="text-headingColor xl:text-[42px] xl:leading-tight lg:text-4xl lg:leading-tight md:text-[44px] md:leading-[3rem] min-[540px]:text-3xl min-[346px]:text-[22px] text-[22px]  font-extrabold capitalize"
                  >
                    Personalised Tutoring Starting from{" "}
                    <span className="text-blueHeading font-MontserratBold">
                     Just £15!
                    </span>
                  </motion.h2>
                  <div className="max-w-3xl md:min-h-20 min-h-24">
                    <Typewriter
                      onInit={(typewriter) => {
                        typewriter
                          .typeString(
                            `<span style='color: #383838; font-family: Montserrat; font-weight: 600' class='typewriter-text'>Achieve your learning goals with dedicated, expert tutors. Tailored lessons that fit your needs and schedule, without the hefty price tag.</span>`
                          )
                          .pauseFor(1000)
                          .callFunction(() => {
                            setIsHeadingDone(true);
