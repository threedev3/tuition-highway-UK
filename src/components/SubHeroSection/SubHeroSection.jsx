...
const SubHeroSection = ({ title, description, btnText, handleNavClick }) => {
  ...
  const isThankyouPage = location.pathname === "/thank-you" || location.pathname === "/faqs";
    ...
    <div className="sm:py-20 py-12 sm:px-12 px-6 max-w-full relative bg-gradient-to-r from-startgrad to-endGrad">
      <div className="max-w-[1400px] mx-auto flex flex-col gap-6 justify-center items-center">
        <div className="flex flex-col gap-2 justify-center items-center">
          ...
          <div>
            <p className="xl:text-lg sm:text-lg min-[540px]:text-base text-sm text-white text-center max-w-3xl capitalize">
              {description}
            </p>
          </div>
        </div>
        ...
        <div
          ...
          onClick={isThankyouPage ? navigateHome : () => handleNavClick("Demo")}
